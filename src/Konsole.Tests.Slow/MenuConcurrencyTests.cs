...
namespace Konsole.Tests.Slow
{
    public class MenuConcurrencyTests
    {
        ...
        public void SeperateThreadsForMenuAndTwoWindows()
        {
            ...
            var client = Window.OpenConcurrent(35, 0, 40, 25, "client", LineThickNess.Single, ConsoleColor.White, ConsoleColor.DarkBlue, console);
            var server = Window.OpenConcurrent(77, 0, 40, 25, "server", LineThickNess.Single, ConsoleColor.White, ConsoleColor.DarkYellow, console);
